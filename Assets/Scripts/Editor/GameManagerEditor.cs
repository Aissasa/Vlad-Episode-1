...
public class GameManagerEditor : TweakableEditor
{
    ...
    protected override void OnBeforeDefaultInspector()
    {
        ...
        EditorGUILayout.HelpBox("This variable effects the bezier curves of the enemies", MessageType.Info);
        ...
        EditorGUILayout.HelpBox("This is the delay between two consecutive pathfinding requests by an enemy", MessageType.Info);
        EditorGUILayout.Space();
        ...
        EditorGUILayout.HelpBox("This variable is used for the precision of an AI reaching a certain point after pathfinding", MessageType.Info);
        EditorGUILayout.Space();
    }
